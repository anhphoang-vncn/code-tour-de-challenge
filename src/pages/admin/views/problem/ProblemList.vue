<template>
  <div class="view">
    <Panel :title="contestId ? this.$i18n.t('m.Contest_Problem_List') : this.$i18n.t('m.Problem_List')">
      ...
      <el-table
        ...
        <el-table-column
          ...
          <div slot-scope="scope">
            ...
            <icon-btn icon="download" name="Tải về Test Case"
                      @click.native="downloadTestCase(scope.row.id)"></icon-btn>
            <icon-btn icon="trash" name="Xóa bài tập"
      ...
      <div class="panel-options">
        <el-button type="primary" size="small"
                   @click="goCreateProblem" icon="el-icon-plus">Tạo mới
        </el-button>
    ...
    <el-dialog title="Bạn có chắc chắn muốn cập nhật? "
               width="20%"
    ...
    <el-dialog title="Thêm bài tập mới cho cuộc thi"
               v-if="contestId"
               width="80%"
