<template>
  <div>
    ...
    <panel title="Xuất bài tập (thử nghiệm)">
      <div slot="header">
        <el-input
          v-model="keyword"
      ...
      <div class="panel-options">
        <el-button type="primary" size="small" v-show="selected_problems.length"
                   @click="exportProblems" icon="el-icon-fa-arrow-down">Tải về
        </el-button>
        <el-pagination
          class="page"
    ...
    <panel title="Nhập bài tập QDU (thử nghiệm)">
      <el-upload
        ref="QDU"
        ...
        <el-button size="small" type="primary" icon="el-icon-fa-upload" slot="trigger">Chọn File</el-button>
        <el-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload('QDU')">Tải lên</el-button>
      </el-upload>
    </panel>

    <panel title="Nhập bài tập FPS (thử nghiệm)">
      <el-upload
        ref="FPS"
        ...
        :on-error="uploadFailed">
        <el-button size="small" type="primary" icon="el-icon-fa-upload" slot="trigger">Chọn File</el-button>
        <el-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload('FPS')">Tải lên</el-button>
      </el-upload>
    </panel>
  </div>
</template>
