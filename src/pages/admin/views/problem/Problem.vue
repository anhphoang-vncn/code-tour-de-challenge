...
<script>
  ...
  export default {
    ...
    data () {
      return {
        rules: {
          _id: {required: true, message: 'Bắt buộc nhập ID hiển thị (chữ hoặc số)', trigger: 'blur'},
          title: {required: true, message: 'Bắt buộc nhập tiêu đề', trigger: 'blur'},
          input_description: {required: true, message: 'Bắt buộc nhập mô tả đầu vào', trigger: 'blur'},
          output_description: {required: true, message: 'Bắt buộc nhập mô tả đầu ra', trigger: 'blur'}
        },
