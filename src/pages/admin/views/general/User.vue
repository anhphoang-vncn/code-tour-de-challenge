  ...
  <div class="view">
    <Panel :title="$t('m.User_User') ">
      ...
      <el-table
        ...
        <el-table-column prop="username" label="Tài khoản"></el-table-column>

        <el-table-column prop="create_time" label="Ngày giờ tạo">
        ...
        <el-table-column prop="real_name" label="Họ tên"></el-table-column>

        <el-table-column prop="email" label="Email"></el-table-column>

        <el-table-column prop="admin_type" label="Loại tài khoản">
          <template slot-scope="scope">
            {{ scope.row.admin_type }}
          </template>
        </el-table-column>

        <el-table-column fixed="right" label="Tùy chọn" width="200">
          <template slot-scope="{row}">
            <icon-btn name="Chỉnh sửa" icon="edit" @click.native="openUserDialog(row.id)"></icon-btn>
            <icon-btn name="Xóa" icon="trash" @click.native="deleteUsers([row.id])"></icon-btn>
          </template>
        </el-table-column>
      </el-table>
      <div class="panel-options">
        <el-form label-width="140px" label-position="left">
	         <el-row :gutter="20">
	           <el-col :span="8">
	             <el-form-item label="Chỉ hiển thị admin">
	               <el-switch
	                 v-model="onlyadmin">
	               </el-switch>
	             </el-form-item>
    ...
    <Panel>
      <span slot="title">{{$t('m.Import_User')}}
        <el-popover placement="right" trigger="hover">
          <p>Chỉ hỗ trợ tệp CSV không có tiêu đề, kiểm tra liên kết  <a
            href="http://docs.onlinejudge.me/#/onlinejudge/guide/import_users">link</a> để biết chi tiết</p>
      ...
      <el-upload v-if="!uploadUsers.length"
        ...
        <el-button size="small" icon="el-icon-fa-upload" type="primary">Tải lên File</el-button>
      </el-upload>
      <template v-else>
    ...
    <Panel :title="$t('m.Generate_User')">
      <el-form :model="formGenerateUser" ref="formGenerateUser">
        <el-row type="flex" justify="space-between">
          <el-col :span="4">
            <el-form-item label="Tiền tố" prop="prefix">
              <el-input v-model="formGenerateUser.prefix" placeholder="Tiền tố"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item label="Hậu tố" prop="suffix">
              <el-input v-model="formGenerateUser.suffix" placeholder="Hậu tố"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item label="Số bắt đầu" prop="number_from" required>
              <el-input-number v-model="formGenerateUser.number_from" style="width: 100%"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item label="Số kết thúc" prop="number_to" required>
              <el-input-number v-model="formGenerateUser.number_to" style="width: 100%"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item label="Độ dài mật khẩu" prop="password_length" required>
              <el-input v-model="formGenerateUser.password_length"
                        placeholder="Độ dài mật khẩu"></el-input>
            </el-form-item>
          </el-col>
        </el-row>

        <el-form-item>
          <el-button type="primary" @click="generateUser" icon="el-icon-fa-users" :loading="loadingGenerate">Tạo & Xuất File CSV
          </el-button>
