        ...
        <el-table
          ...
          <el-table-column
            ...
            <div slot-scope="scope">
              <icon-btn name="Chỉnh sửa" icon="edit" @click.native="openAnnouncementDialog(scope.row.id)"></icon-btn>
              <icon-btn name="Xóa" icon="trash" @click.native="deleteAnnouncement(scope.row.id)"></icon-btn>
            </div>
          </el-table-column>
        </el-table>
    ...
    methods: {
      ...
      openAnnouncementDialog (id) {
        ...
        if (id !== null) {
          ...
          this.announcementDialogTitle = 'Chỉnh sửa thông báo'
