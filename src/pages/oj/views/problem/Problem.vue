    ...
    <div id="problem-main">
      ...
      <Card :padding="20" dis-hover>
        ...
        <ul style="margin-left: 30px;margin-top: 20px;">
          <li rel="nofollow noopener noreferrer" target="_blank" class="animation-text" >Quy tắc thảo luận &#38; hướng dẫn đăng bình luận ✍️</li>
          ...
          <!-- <li>Tham gia thảo luận bài tập tại
            <span style="position: relative;">
              <a href="" target="_blank" style="position: absolute; left: 10px">
                <img alt="Discord" src="">
              </a>
            </span>
          </li> -->
